...
namespace Vaultaria.Content.Items.Accessories.Skills
{
    public class Wreck : ModSkill
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            int bonusDamage = SkillUtilities.DisplaySkillBonusText(80f, 0.05f);

            ItemText.Text(tooltips, Mod, "Tooltip1", "While an enemy is Phaselocked you gain increased Fire Rate and Damage for Magic weapons");
            ...
            ItemText.Text(tooltips, Mod, "Tooltip4", $"+{bonusDamage}% Magic Damage");
        }
    }
}