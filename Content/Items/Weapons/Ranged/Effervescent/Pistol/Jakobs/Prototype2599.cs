...
namespace Vaultaria.Content.Items.Weapons.Ranged.Effervescent.Pistol.Jakobs
{
    public class Prototype2599 : VaultarianItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            ItemText.Text(tooltips, Mod, "Tooltip2", "- Developer Note: This weapon is a tribute to my daughter.", ItemText.VaultarianColours.Healing);
            ItemText.RedText(tooltips, Mod, "Tooltip3", "An ode to Maxine");
        }
    }
}