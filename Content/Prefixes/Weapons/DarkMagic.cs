...
{
    public class DarkMagic : ModPrefix
    {
        ...
        {
            yield return new TooltipLine(Mod, "DarkMagic", "Restores 2% of Damage back as health")
            {
                OverrideColor = ItemText.VaultarianColours.DarkMagic.GetVaultarianColor()
            };
        }
    }
}
